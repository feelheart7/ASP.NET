...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="BBS.Edit" Title="帖子信息修改" %>
...
<div class="panel panel-primary">
   <div class="panel-heading">
    ...
    <asp:Label ID="Label2" runat="server" Text="编辑帖子"></asp:Label></strong></h3>
    </div>
