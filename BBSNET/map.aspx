<%@ Page Language="C#" AutoEventWireup="true" CodeFile="map.aspx.cs" Inherits="BBS.map" %>
...
<script type="text/javascript">
	...
	map.centerAndZoom(new BMap.Point(117.197488,36.683748), 17);  // 初始化地图,设置中心点坐标和地图级别	
	map.enableScrollWheelZoom(true);     //开启鼠标滚轮缩放
	var point = new BMap.Point(117.197488,36.683748);
	...
	var infoWindow = new BMap.InfoWindow("地址： 山东 济南市历城区凤鸣路1000号", opts);  // 创建信息窗口对象 
